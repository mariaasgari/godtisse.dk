        ...
        <div className="max-w-5xl lg:max-w-6xl mx-auto">
          ...
          <Card className="border-2 border-primary/20 shadow-lg bg-gradient-to-br from-primary/5 to-accent/5 mb-6 md:mb-8 lg:mb-10">
            <CardContent className="p-4 sm:p-6 md:p-8 lg:p-10">
              <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 lg:gap-6 mb-4 lg:mb-6">
                ...
                <div>
                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-semibold">Dagligt</h3>
          ...
          <Card className="border-2 border-orange-500/30 bg-gradient-to-br from-orange-50/80 to-amber-50/80 dark:from-orange-950/30 dark:to-amber-950/30 shadow-lg">
            <CardContent className="p-4 sm:p-6 md:p-8 lg:p-10">
              ...
              <div className="mt-6 p-4 bg-background/50 rounded-lg border border-orange-200 dark:border-orange-900/30 max-w-2xl mx-auto">

...
export const ReferencesSection = () => {
  const sortedReferences = [...references].sort((a, b) =>
    a.authors.localeCompare(b.authors, 'da')
  );

  return (
    <section id="references" className="py-12 md:py-20 lg:py-24 bg-gradient-to-b from-muted/30 to-background">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-5xl lg:max-w-6xl mx-auto">
          ...
          <Card className="border-2 border-secondary/20 shadow-lg mb-6 md:mb-8 lg:mb-10">
                  ...
                  >
                    <div className="flex items-start gap-2 sm:gap-3 lg:gap-4 mb-2 sm:mb-3">
                      <div className="flex-shrink-0 w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 rounded-full bg-secondary/20 flex items-center justify-center">
                        <span className="text-xs sm:text-sm lg:text-base font-bold text-secondary">{index + 1}</span>
                      </div>

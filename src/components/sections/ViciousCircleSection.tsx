            ...
            <Card className="bg-gradient-to-br from-pink-50/50 to-rose-50/50 dark:from-pink-950/20 dark:to-rose-950/20 border-2 border-pink-200 dark:border-pink-900/30 shadow-lg max-w-4xl mx-auto">
              <CardContent className="p-4 sm:p-6 lg:p-10">
                ...
                <div className="relative mb-4 md:mb-6 lg:mb-8 flex justify-center overflow-visible">
                  <div className="relative w-[260px] h-[260px] sm:w-[300px] sm:h-[300px] md:w-[360px] md:h-[360px] lg:w-[400px] lg:h-[400px]">
                    {/* Central circle with arrows showing rotation */}
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative w-24 h-24 sm:w-28 sm:h-28 md:w-36 md:h-36 rounded-full border-2 border-dashed border-pink-300 dark:border-pink-700 animate-[spin_20s_linear_infinite]"></div>
                    </div>

                    {/* Step 1: Dysbiose - Top */}
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 flex flex-col items-center text-center group">
                      <div className="bg-gradient-to-br from-pink-100 to-pink-50 dark:from-pink-900/40 dark:to-pink-900/20 rounded-xl w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 flex items-center justify-center mb-1 sm:mb-2 border-2 border-pink-300 dark:border-pink-700 shadow-md group-hover:scale-110 transition-transform duration-300">
                      ...
                      <div className="bg-pink-100/50 dark:bg-pink-900/20 rounded-lg px-1 py-0.5 sm:px-2 sm:py-1.5 border border-pink-200 dark:border-pink-800">
                        <p className="text-[10px] sm:text-xs md:text-sm font-bold text-pink-900 dark:text-pink-100">
                          Dysbiose
                        </p>
                        <p className="hidden sm:block text-xs md:text-sm text-pink-700 dark:text-pink-300">
                          Ubalance i mikrobiota
                        </p>
                      </div>
                      {/* Arrow pointing right */}
                      <ArrowRight className="absolute -right-3 sm:-right-8 top-4 sm:top-6 md:top-7 h-3 w-3 sm:h-5 sm:w-5 text-pink-500 dark:text-pink-400 rotate-45" />
                    </div>

                    <div className="absolute right-0 top-1/2 -translate-y-1/2 flex flex-col items-center text-center group">
                      <div className="bg-gradient-to-br from-rose-100 to-rose-50 dark:from-rose-900/40 dark:to-rose-900/20 rounded-xl w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 flex items-center justify-center mb-1 sm:mb-2 border-2 border-rose-300 dark:border-rose-700 shadow-md group-hover:scale-110 transition-transform duration-300">
                      ...
                      <div className="bg-rose-100/50 dark:bg-rose-900/20 rounded-lg px-1 py-0.5 sm:px-4 sm:py-1.5 border border-rose-200 dark:border-rose-800 whitespace-nowrap">
                        ...
                        <p className="hidden sm:block text-xs md:text-sm text-pink-700 dark:text-pink-300">Mindre surt</p>
                      </div>
                      {/* Arrow pointing down */}
                      <ArrowRight className="absolute -bottom-3 sm:-bottom-8 left-4 sm:left-6 md:left-7 h-3 w-3 sm:h-5 sm:w-5 text-rose-500 dark:text-rose-400 rotate-[135deg]" />
                    </div>
                    ...
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex flex-col items-center text-center group">
                      <div className="bg-gradient-to-br from-fuchsia-100 to-fuchsia-50 dark:from-fuchsia-900/40 dark:to-fuchsia-900/20 rounded-xl w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 flex items-center justify-center mb-1 sm:mb-2 border-2 border-fuchsia-300 dark:border-fuchsia-700 shadow-md group-hover:scale-110 transition-transform duration-300">
                        <span className="text-base sm:text-2xl">🦠</span>
                      </div>
                      ...
                      {/* Arrow pointing left */}
                      <ArrowRight className="absolute -left-3 sm:-left-8 top-4 sm:top-6 md:top-7 h-3 w-3 sm:h-5 sm:w-5 text-fuchsia-500 dark:text-fuchsia-400 rotate-[225deg]" />
                    </div>

                    {/* Step 4: UVI - Left */}
                    <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col items-center text-center group">
                      <div className="bg-gradient-to-br from-pink-200 to-pink-100 dark:from-pink-800/50 dark:to-pink-800/30 rounded-xl w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 flex items-center justify-center mb-1 sm:mb-2 border-2 border-pink-400 dark:border-pink-600 shadow-md group-hover:scale-110 transition-transform duration-300">
                        <span className="text-base sm:text-2xl">⚡</span>
                      </div>
                      <div className="bg-pink-200/50 dark:bg-pink-800/20 rounded-lg px-1 py-0.5 sm:px-2 sm:py-1.5 border border-pink-300 dark:border-pink-700">
                        <p className="text-[10px] sm:text-xs md:text-sm font-bold text-pink-900 dark:text-pink-100">Ny UVI</p>
                        <p className="hidden sm:block text-xs md:text-sm text-pink-700 dark:text-pink-300">
                          Blærebetændelse
                        </p>
                      </div>
                      {/* Arrow pointing up */}
                      <ArrowRight className="absolute -top-3 sm:-top-8 left-4 sm:left-6 md:left-7 h-3 w-3 sm:h-5 sm:w-5 text-pink-500 dark:text-pink-400 rotate-[315deg]" />
                    </div>
